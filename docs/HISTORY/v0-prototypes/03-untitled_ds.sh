...
# 作者: @皓thirteen (2026.8.12)
# 描述: 将普通 Shell 脚本混淆为经过 VM 加密执行的混淆脚本
# 用法: OBFUSCATION_LEVEL=1|2|3 bash ThirteenProtect_V2_restored.sh <input.sh> [output.sh]
# 示例: bash ThirteenProtect_V2_restored.sh zh_demo.sh
#==============================================================================
#
# 实现特性：
